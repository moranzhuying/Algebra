...
\begin{definition}{映射的正向系统和正向极限}{}
	记号同推论(\ref{cor:universal-property-of-direct-limits-of-a-family-of-mappings}).
	\begin{enumerate}
...
\begin{corollary}{}{}
	记号同推论(\ref{cor:universal-property-of-direct-limits-of-a-family-of-mappings}).若$\left(u_{\alpha}\right)_{\alpha\in I}$是一族单射(相应的,满射,双射),则$u$也是单射(相应的,满射,双射).
\end{corollary}
...
\begin{definition}{子集的正向系统}{}
	记号和假设同命题(\ref{prop:properties-of-subsets-of-direct-ststem}).我们称$\left(M_{\alpha}\right)_{\alpha\in I}$是$\left(E_{\alpha}\right)_{\alpha\in I}$的正向系统的子集.
\end{definition}
