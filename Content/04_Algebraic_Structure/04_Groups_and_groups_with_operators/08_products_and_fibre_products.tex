...
\begin{proposition}{部分乘积子群的性质}{}
	设$J,J_{1},J_{2}\subseteq I$,其他记号同定义(\ref{def:partial-product-omega-group}).
	\begin{enumerate}
...
\begin{proposition}{纤维积的投影同态}{}
	沿用定义\ref{def:fibre-product-of-omega-group}的记号,那么如下图表交换.
	\begin{center}
		\begin{tikzcd}
...
\begin{proposition}{纤维积的泛性质}{}
	沿用定义\ref{def:fibre-product-of-omega-group}的记号.对诸$\Omega$-群$K$,$\Omega$-群同态$f_{i}:K\to G_{i}$($i\in\left\{1,2\right\}$),下图中,左边的图表交换$\implies$右边的图表交换.
	\begin{center}
		\begin{tikzcd}
