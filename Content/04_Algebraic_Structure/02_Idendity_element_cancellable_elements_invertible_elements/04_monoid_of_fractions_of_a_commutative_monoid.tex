...
\begin{definition}{分式幺半群}{}
	设$\mathcal{R}$如引理(\ref{lem:compatible-equivalent-relation-over-commucative-monoid})定义.我们称$E_{S}\coloneq\left(E\times S^{\prime}\right)/\mathcal{R}$为$E$相伴于$S$的分式幺半群.
\end{definition}
