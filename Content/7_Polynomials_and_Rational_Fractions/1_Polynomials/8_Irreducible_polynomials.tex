...
\begin{definition}{不可约多项式}{}
	设$f\in K\left[X\right]$.若命题(\cref{prop:equivalent-definition-of-irreducible-polynomials})的陈述之一成立,则称$f$是$K$上的不可约多项式.
\end{definition}
...
\begin{definition}{无平方因子多项式的等价定义}{}
	若命题(\cref{prop:equivalent-definition-of-square-free-polynomials})的陈述之一成立,则称$f$为无平方因子多项式(或$f$没有重因式).
\end{definition}
