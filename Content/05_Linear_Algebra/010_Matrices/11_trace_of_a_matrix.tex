...
\begin{proposition}{迹诱导的对偶空间同构}{}
	对任一$\boldsymbol{P}\in\mathbf{M}_{n}\left(C\right)$,记$f_{\boldsymbol{P}}:\mathbf{M}_{n}\left(C\right)\to\mathbf{M}_{n}\left(C\right),\boldsymbol{X}\mapsto\tr\left(\boldsymbol{P}\boldsymbol{X}\right)$,则$\mathbf{M}_{n}\left(C\right)\to\left(\mathbf{M}_{n}\left(C\right)\right)^{\vee},\boldsymbol{P}\mapsto f_{\boldsymbol{P}}$是$C$-线性同构.
\end{proposition}

\begin{proposition}{迹的唯一性表征}{}
	设$f\in\left(\mathbf{M}_{n}\left(C\right)\right)^{\vee}$且$\forall\boldsymbol{X},\boldsymbol{Y}\in\mathbf{M}_{n}\left(R\right)\left(f\left(\boldsymbol{X}\boldsymbol{Y}\right)=f\left(\boldsymbol{Y}\boldsymbol{X}\right)\right)$,则有唯一的$c\in C$使$\forall\boldsymbol{X}\in\mathbf{M}_{n}\left(R\right)\left(f\left(\boldsymbol{X}\right)=c\tr\left(\boldsymbol{X}\right)\right)$.
\end{proposition}
