...
\begin{corollary}{}{}
	设$\boldsymbol{X},\boldsymbol{Y}\in\Mat_{n}\left(A\right)$.若$\boldsymbol{X}$和$\boldsymbol{Y}$相似,则$\det\left(\boldsymbol{X}\right)=\det\left(\boldsymbol{Y}\right)$.
\end{corollary}

\begin{proposition}{}{}
	设$\boldsymbol{X}\in\Mat_{n}\left(A\right)$,则$\left(\col_{i}\left(\boldsymbol{X}\right)\right)_{i=1}^{n}$线性无关$\iff$ $\det\left(\boldsymbol{X}\right)$不是$A$中的零因子.
\end{proposition}
