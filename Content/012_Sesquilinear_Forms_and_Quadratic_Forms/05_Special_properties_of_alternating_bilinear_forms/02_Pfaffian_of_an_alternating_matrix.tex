...
\begin{definition}{}{}
	沿用\ref{lem:n-partition-correspond-to-a-permutation}的记号.对每个$S\in\mathcal{P}_{n}\left(m\right)$,称$\sigma_{S}$是$S$诱导的置换.
\end{definition}
...
\begin{proposition}{Pfaff值的性质}{}
	\begin{enumerate}
		\item 对每个$\boldsymbol{P}\in\mathbf{M}_{2n}\left(A\right)$有$\Pf\left(\boldsymbol{P}^{\top}\boldsymbol{A}\boldsymbol{P}\right)=\det\left(\boldsymbol{P}\right)\Pf\left(\boldsymbol{A}\right)$.
