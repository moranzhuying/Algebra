...
\begin{definition}{仿射正交投影}{}
	沿用引理\ref{lem:well-definedness-of-affine-orthogonal-projection}的记号.我们称$P_{V}$是$S$在$V$上的仿射正交投影.
\end{definition}
...
\begin{definition}{仿射位移群,仿射相似群}{}
	沿用引理\ref{lem:well-definedness-of-affine-displacement-group-and-affine-similitude-group}的记号.
	\begin{enumerate}
...
\begin{definition}{特殊仿射位移变换群}{}
	沿用引理\ref{lem:well-definedness-of-special-affine-displacement-group}的记号.我们称$\Disp^{+}\left(\varphi\right)$是$\varphi$的特殊仿射位移变换群.
\end{definition}
