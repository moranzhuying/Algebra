...
\begin{definition}{关于子空间的正交反射}{}
	沿用推论\ref{cor:correspondence-of-unitary-involutions-and-non-isotropic-subspaces}的记号.对$E$的$\varphi$-非迷向子空间$M$,我们称$s_{M}\coloneq\varphi\left(M\right)$是$E$上关于$M$的正交反射.
\end{definition}
