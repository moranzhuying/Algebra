...
\begin{definition}{二次模的直和}{}
	沿用命题(\cref{prop:construction-of-exterior-direct-sum-of-quadratic-modules})的设定.
	\begin{enumerate}
...
\begin{definition}{商二次模}{}
	沿用\cref{prop:construction-of-quotient-quadratic-module}的记号.当$F\subseteq N$时,称$\left(E/F,\bar{Q}\right)$是$\left(E,Q\right)$模$F$的二次模,称$\bar{Q}$是$Q$和$E/F$诱导的二次型.
\end{definition}
...
\begin{definition}{二次型的标量扩张}{}
	沿用\cref{prop:construction-of-quadratic-form}的记号.我们称$h^{\ast}\left(Q\right)\coloneq h^{\ast}Q\coloneq Q^{\prime}$是$Q$通过$h$的标量扩张.
\end{definition}
