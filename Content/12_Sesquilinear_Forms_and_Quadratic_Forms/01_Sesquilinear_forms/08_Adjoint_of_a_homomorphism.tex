...
\begin{definition}{线性映射的左伴随}{}
	沿用命题\ref{prop:left-adjoint-of-linear-mappings-bilinear-and-sesquilinear-version}的设定.我们称${}^{\ast}u$是$u$相对$\left(\varphi,\varphi^{\prime}\right)$的左伴随.
\end{definition}
...
\begin{definition}{线性映射的右伴随}{}
	沿用命题\ref{prop:left-adjoint-of-linear-mappings-bilinear-and-sesquilinear-version}(或\ref{prop:left-adjoint-of-linear-mappings-sesquilinear-version})的设定.我们称$v^{\ast}$是$v$相对$\left(\varphi,\varphi^{\prime}\right)$的右伴随.
\end{definition}
