...
\begin{definition}{双线性映射的拉回}{}
	沿用引理(\cref{lem:well-definedness-and-properties-of-pullback-of-bilinear-mappings})的记号.我们称$\varphi^{\prime}$是$\varphi$沿$\left(u,v\right)$的拉回,并把$\varphi^{\prime}$记作$\varphi_{\ast}$.
\end{definition}
