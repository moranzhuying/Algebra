...
\begin{definition}{半双线性型的张量积}{}
	沿用\cref{prop:tensor-product-of-sesquilinear-mappings}的记号.我们称$\bigotimes\limits_{i=1}^{n}\varphi_{i}\coloneq\bar{\varphi}$是$\left(\varphi_{i}\right)_{i=1}^{n}$的张量积.
\end{definition}
...
\begin{definition}{半双线性型的外幂}{}
	沿用\cref{prop:exterior-power-of-sesquilinear-mapping}的记号.我们称$\bigwedge\limits^{n}\varphi\coloneq\phi_{\left(n\right)}$是$\varphi$到$\bigwedge^{n}E$的扩张.
\end{definition}
