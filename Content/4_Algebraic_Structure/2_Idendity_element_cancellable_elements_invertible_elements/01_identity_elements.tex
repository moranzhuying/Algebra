...
\begin{remark}{记号说明}{}
	...
	\end{enumerate}
	在上述记号的意义下,定理(\ref{thm:associativity-theorem}),(\ref{thm:commutative-theorem}),(\ref{thm:fubini-theorem-of-sequence-composition-in-semi-group})及其推论在指标集为空的情形下仍然成立.
\end{remark}
...
\begin{remark}{记号说明}{}
	在上述记号的意义下,定理(\ref{thm:associativity-theorem}),(\ref{thm:commutative-theorem}),(\ref{thm:fubini-theorem-of-sequence-composition-in-semi-group})及其推论在元素族有限支撑的情形下仍然成立.
\end{remark}
