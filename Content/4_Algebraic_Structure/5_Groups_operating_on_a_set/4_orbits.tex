...
\begin{definition}{$G$-等价}{}
	...
	\begin{enumerate}
		...
		\begin{align*}
			\orbit_{l,G}\left(x\right)\coloneq\mathcal{O}_{x}\coloneq\left\{z\in G\middle|\exists\alpha\in G\left(z=\alpha x\right)\right\}
		\end{align*}
		为$x$的(左)$G$-轨道.
		\item 设$E$是右$G$-集.若$\exists\alpha\in G\left(y=x \alpha\right)$,则称$y$和$x$在$G$的作用下(右)共轭(或右$G$-等价).定义
		\begin{align*}
			\orbit_{G,r}\left(x\right)\coloneq\mathcal{O}_{x}\coloneq\left\{z\in G\middle|\exists\alpha\in G\left(z=x \alpha\right)\right\}
		\end{align*}
		为$x$的(右)$G$-轨道.
	\end{enumerate}
\end{definition}
...
\begin{proposition}{双重轨道}{}
	设$\left(\left(g,x\right),h\right)\mapsto gxh$是$G\times H^{\op}$在$E$上的左作用.对任一$x\in G$,记$\orbit_{l,G-H,r}\left(x\right)$是$x$在该左作用下的轨道,则
	\begin{align*}
		\orbit_{l,G-H,r}\left(x\right)=GxH.
	\end{align*}
