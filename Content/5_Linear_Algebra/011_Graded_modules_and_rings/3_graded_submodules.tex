...
\begin{definition}{$\Delta$型分次子模}{}
	设$N$是$M$的子模.命题(\cref{prop:equivalent-condition-of-graded-submodules})的陈述之一为真时,称$\left(N\cap M_{\lambda}\right)_{\lambda\in\Delta}$是$M$在$N$上诱导的分次,配备该分次的$N$称为$M$的$\Delta$型分次子模.
\end{definition}
